     ...
     <div class="bg-light shadow-lg rounded-3 mb-4" style="margin-top: -35px;">
          ...
          <div class="d-flex flex-wrap">
            ...
            <div class="dropdown mb-lg-3 mb-2 me-lg-3 me-2">
              ...
              <button class="btn btn-outline-accent w-100" role="link" onclick="window.location='maleta.php'" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">maletas</button>
            
            </div>
            <!-- Sale Types-->
            <div class="dropdown mb-lg-3 mb-2 me-lg-3 me-2">
              <button class="btn btn-outline-accent w-100" role="link" onclick="window.location='#?2'" data-name="cat2" onclick="SeleccionCat(this)" id="rumba" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">futball</button>
            
            </div>
            <!-- Price range-->
            <div class="dropdown mb-lg-3 mb-2 me-lg-3 me-2">
              <button class="btn btn-outline-accent w-100" role="link" onclick="window.location='#?3'" data-name="cat3" onclick="SeleccionCat(this)" id="salllsa" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">INTERSHIP</button>
             
            </div>
            <!-- Collections-->
            <div class="dropdown mb-lg-3 mb-2 me-lg-3 me-2">
              <button class="btn btn-outline-accent w-100" role="link" onclick="window.location='#?4'" data-name="cat4" onclick="SeleccionCat(this)" id="salsa" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">TRANSFERS</button>
    ...
    <div class="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 gy-sm-4 gy-3 pt-sm-3" id="contenido1">
      ...
      <form action="" method="post">
          <div class="col mb-2">
            ...
            <input type="hidden" name="product_n_service" value="<?php echo $fetch_product['n_service']; ?>">
